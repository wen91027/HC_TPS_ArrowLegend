...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject* Factory_Create_m9D2714E3627BA7FA59E66C96BD459072D14110A7 (bool ___mocked0, const RuntimeMethod* method)
{
...
{
	{
		...
		String_t* L_0 = ___id0;
		WinProductDescription_set_platformSpecificID_m4A668AB347E9ACFCFCEA2D95789A8902EFB282AB_inline(__this, L_0, /*hidden argument*/NULL);
		String_t* L_1 = ___price1;
		WinProductDescription_set_price_mDFCD8D6F84C07FE50510C8E31161E18E1959FC5F_inline(__this, L_1, /*hidden argument*/NULL);
		String_t* L_2 = ___title2;
		WinProductDescription_set_title_m93BA50E01B8CB7C53EA543D219BD13C0C3C4FB3B_inline(__this, L_2, /*hidden argument*/NULL);
		String_t* L_3 = ___description3;
		WinProductDescription_set_description_mE9CC9EFD4812A411FE1277A2BEB3AAC3D6029B30_inline(__this, L_3, /*hidden argument*/NULL);
		String_t* L_4 = ___isoCode4;
		WinProductDescription_set_ISOCurrencyCode_mF097ACEF0DD143A28A79AF5252172CE7C7F3D1A6_inline(__this, L_4, /*hidden argument*/NULL);
		Decimal_t44EE9DA309A1BF848308DE4DDFC070CAE6D95EE8  L_5 = ___priceD5;
		WinProductDescription_set_priceDecimal_m118EA165F28FE0A959EC523CEE6593D49804ADA9_inline(__this, L_5, /*hidden argument*/NULL);
		String_t* L_6 = ___receipt6;
		WinProductDescription_set_receipt_m76ACC63CA0A4118B610168B762041E4D09FAD613_inline(__this, L_6, /*hidden argument*/NULL);
		String_t* L_7 = ___transactionId7;
		WinProductDescription_set_transactionID_mD04E4530777C2EB26DE555FBF0D895EA88CE6AA6_inline(__this, L_7, /*hidden argument*/NULL);
		bool L_8 = ___consumable8;
		WinProductDescription_set_consumable_m90A3535F5715F4972444062F7DE3A1CC549D5582_inline(__this, L_8, /*hidden argument*/NULL);
		return;
	}
}
#ifdef __clang__
